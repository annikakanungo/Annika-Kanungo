...
if (!prefersReducedMotion){
  try {
    ...
    const scrambleTargets = Array.from(document.querySelectorAll('h1, h2')).filter(el => !el.closest('.hero'));
  ...
  } catch (err) { console.error('Heading scramble effect failed to initialize:', err); }
}
